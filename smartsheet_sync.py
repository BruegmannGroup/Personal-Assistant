...
def push_encounter_record(record: dict) -> dict:
    ...
    fields = {
        ...
        "desired_learning": record.get("desired_learning", ""),
        "success_criteria": _join(record.get("success_criteria")),
        "decision_possible": record.get("decision_possible", ""),
        "observations": _join(record.get("observations")),
        "view_changed": record.get("view_changed", ""),
        "decisions_made": _join(record.get("decisions_made")),
        "discussed_not_decided": _join(record.get("discussed_not_decided")),
        "commitments_summary": _commitments_summary(record.get("commitments")),
        "action_classification": record.get("action_classification", ""),
        "strategic_learning": record.get("strategic_learning", ""),
        "followup_questions": _join(record.get("followup_questions")),
